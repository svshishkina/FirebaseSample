...
class LeftMessageController(val profileClickAction: (uid: String) -> Unit) : BindableItemController<MessageUI, LeftMessageController.Holder>() {

    override fun getItemId(message: MessageUI) = message.id.hashCode().toLong()

    override fun createViewHolder(parent: ViewGroup?) = Holder(parent)

    inner class Holder(parent: ViewGroup?) : BindableViewHolder<MessageUI>(parent, R.layout.left_chat_item) {
